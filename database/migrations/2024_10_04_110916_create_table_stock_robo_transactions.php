 ...
 *- -***
 * @example
 * php artisan migrate:refresh --path=./database/migrations/2024_10_04_110916_create_table_stock_robo_transactions.php
 */
return new class extends Migration {
    private const TABLE_NAME = 'stock_robo_transactions';
