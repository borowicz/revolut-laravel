...
class StockTransactionFactory extends AbstractRevolut
{
    ...
    public function definition()
    {
        return [
            ...
            'price_per_share' => $this->faker->randomFloat(2, 0, 1000), // Random price per share between 0 and 1000
            'total_amount' => $this->faker->randomFloat(2, 0, 1000000), // Random total amount between 0 and 1000000
            'currency' => $this->faker->currencyCode, // Random currency code
            'fx_rate' => $this->faker->randomFloat(4, 0.5, 1.5), // Random FX rate between 0.5 and 1.5
        ];
    }
}
